...
import { EmployeeAttendanceManagement } from "@/features/employee-attendance/employee-attendance-management";
...
export function AttendanceManagement({ schoolId }: { schoolId: string }) {
  ...
  return <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
    ...
    {tab === "employees" && <EmployeeAttendanceManagement schoolId={schoolId} />}
  </motion.div>;
}
